...
public class EditableLabelNumberField extends HorizontalLayout
	implements HasValue<ComponentValueChangeEvent<EditableLabelNumberField, Double>, Double>
{
	...
	public Registration addValueChangeListener(
		final ValueChangeListener<? super ComponentValueChangeEvent<EditableLabelNumberField, Double>> listener)
	{
	...
	/**
	 * Event handler delegate method for the {@link NumberField} {@link #textField}.
	 *
	 * @eventHandlerDelegate Do NOT delete, used by UI designer!
	 * @see ComponentEventListener#onComponentEvent(ComponentEvent)
	 */
	private void textField_onBlur(final BlurEvent<NumberField> event)
	{
		if(this.label.getText().contentEquals(this.textField.getValue().toString()))
		{
	 ...
	 */
	private void textField_valueChanged(final ComponentValueChangeEvent<NumberField, Double> event)
	{
	...
	{
		this.label.setText(this.textField.getValue().toString());
